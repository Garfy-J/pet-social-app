...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="btn w-full border-2 border-black/10 bg-white text-foreground hover:bg-black/[0.02]"
    >
      <svg viewBox="0 0 48 48" className="h-4 w-4">
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.4 0 10.3-2.1 14-5.5l-6.5-5.5c-2 1.5-4.6 2.5-7.5 2.5-5.3 0-9.7-3.1-11.3-7.5l-6.6 5.1C9.5 39.5 16.2 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.4-2.3 4.4-4.3 5.9l6.5 5.5C41.4 36.7 44 30.9 44 24c0-1.3-.1-2.7-.4-3.5z"
        />
      </svg>
